...
- 支持的 ONNX opset_version >= 11，详细算子描述可参考 [onnx Operators](https://github.com/onnx/onnx/blob/main/docs/Operators.md) 。
...
| ReduceMin             | - axes: 无限制 <br> - keepdims: 无限制 <br> - noop_with_empty_axes: 该参数暂不支持                                                                                                   |
...
| SpatialTransformer    | 插值方式为 "bilinear", 边界处理方式为 "constant"（值为0）                                         |
